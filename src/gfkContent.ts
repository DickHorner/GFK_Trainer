// src/gfkContent.ts
// Didaktisches Inhaltsmodell für den GFK-Trainer (12 Kapitel, jeweils mehrere Übungen).
...
// Tabellen-/Matrix-Übung (Zeilen x Spalten)
...
// Übersetzungsübung (z. B. Wolf → Giraffe), mehrere Paare
export interface TranslateExercise extends BaseExercise {
  type: "translate";
  items: number; // Anzahl Paare
}

// Checkliste mit boolschen Häkchen
export interface ChecklistExercise extends BaseExercise {
  type: "checklist";
  items: string[];
}

// Rating-Übung (0–10, mit optionalem Kommentar)
export interface RatingExercise extends BaseExercise {
  type: "rating";
}

// Timer-Übung (z. B. 2-Minuten-Empathie)

 ...
 */
import { parseAndRepairJsonResponse } from './schema';
/**
 ...
 */
export function setLLMConfig(newConfig) {
 ...
 */
function buildEvaluationPrompt(exercise, fieldId, fieldContent, fieldType) {
 ...
 */
export async function evaluateField(exercise, fieldId, fieldContent, fieldType) {
    if (!config.enabled) {
 ...
 */
export function loadConfigFromFile(configJson) {
    try {
